    ...
    <div class="row">
        ...
        <div class="col-lg-9">
          <form action="add_product.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <input type="submit" name="add_Pro" value="add_pro" class="btn btn-danger w-100">
                </div>
          </form>
        </div>
...
if(isset($_POST['add_Pro'])){
    ...
    $query = mysqli_query($connect,"insert into products (p_title, p_category_id, brand, price, p_description, discount_price, image)
     value ('$title','$category','$brand','$price','$description','$discount_price','$image')");
